...
n_slider = st.sidebar.slider("Pocet bodu (slider)", min_value=3, max_value=500, value=20)
n_manual = st.sidebar.number_input("Pocet bodu (manualne)", min_value=3, max_value=500, value=n_slider, step=1)
n = n_manual if n_manual else n_slider
